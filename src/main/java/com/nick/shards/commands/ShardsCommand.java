...
public class ShardsCommand implements TabCompleter, CommandExecutor {
                    ...
                    if(shards.get(args[2]) != null) {
                        ...
                        if(player.getInventory().getItemInOffHand() != null) {
                            if(player.getInventory().getItemInOffHand().getItemMeta() != null) {
                                if(shards.get(player.getInventory().getItemInOffHand().getItemMeta().getItemName()) != null) {
            ...
            if(args[0].equalsIgnoreCase("reset")) {
                ...
                if(player != null) {
                    ...
                    for(Player online_player : Bukkit.getServer().getOnlinePlayers()) {
                        ...
                        if(online_player.getInventory().getItemInOffHand() != null) {
                            if(online_player.getInventory().getItemInOffHand().getItemMeta() != null) {
                                if(shards.get(online_player.getInventory().getItemInOffHand().getItemMeta().getItemName()) != null) {
    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String label, String[] args) {
        if(args.length == 1) {
            return List.of("set", "reset", "upgrade");
        }
        ...
        if(args.length == 3 && args[0].equalsIgnoreCase("set")) {
            return new ArrayList<String>(shards.keySet());
        }
